...
|
*/
// $config['base_url'] = 'http://localhost:90/perpusdig/';
...
|
*/
$config['encryption_key'] = 'perpusdig-super-secret-2026';
...
$config['csrf_token_name'] = 'csrf_token_perpus';
$config['csrf_cookie_name'] = 'csrf_cookie_perpus';
